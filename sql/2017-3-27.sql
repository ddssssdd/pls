...
insert  into `user`(`id`,`username`,`password`) values (1,'admin','admin'),(2,'user','user'),(4,'13953253109','13953253109'),(5,'121','121'),(6,'123','123'),(8,'33','33');
...
insert  into `vendor_contact`(`id`,`cellphone`,`email`,`name`,`phone`,`user_id`,`vendor_id`) values (1,'13953253109','a@a.com','michael','4343',4,2),(3,'121','c@c.com','test','test',5,NULL),(4,'123','1','1','1',6,2),(6,'33','33','33','33',8,2);
