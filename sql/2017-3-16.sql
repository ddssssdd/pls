...
insert  into `event_detail`(`id`,`description`,`end_time`,`event_id`,`start_time`,`user_id`) values (1,'如何验证密码',NULL,14,NULL,1),(2,'角色的多个内容',NULL,14,NULL,1),(3,'分离模块？',NULL,14,NULL,1),(4,'动态加载菜单',NULL,15,NULL,1),(5,'菜单的管理',NULL,15,NULL,1),(6,'用户和菜单的关联',NULL,15,NULL,1),(7,'产品字典表的设计',NULL,16,NULL,1),(8,'bom的分解',NULL,16,NULL,1),(9,'分页的设计',NULL,17,NULL,1),(10,'UI研究',NULL,17,NULL,1),(11,'如何保存即可用？',NULL,18,NULL,1);
